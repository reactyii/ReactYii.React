...
define(["require", "exports", "react", "react-router-dom"], function (require, exports, React, react_router_dom_1) {
    ...
    var Paginator = /** @class */ (function (_super) {
        ...
        Paginator.prototype.renderFirstLink = function (url) {
            return React.createElement(react_router_dom_1.Link, { key: "first", to: url }, "First");
        };
        Paginator.prototype.renderLastLink = function (url, ind) {
            return React.createElement(react_router_dom_1.Link, { key: "last", to: url }, "Last");
        };
        Paginator.prototype.renderPrevLink = function (url, ind) {
            return React.createElement(react_router_dom_1.Link, { key: "prev", to: url }, "Prev");
        };
        Paginator.prototype.renderPage = function (url, ind) {
            return React.createElement(react_router_dom_1.Link, { key: ind, to: url }, ind);
        };
        ...
        Paginator.prototype.renderNextLink = function (url, ind) {
            return React.createElement(react_router_dom_1.Link, { key: "next", to: url }, "Next");
        };
