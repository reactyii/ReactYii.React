...
define(["require", "exports", "react/jsx-runtime", "react", "react-router-dom"], function (require, exports, jsx_runtime_1, React, react_router_dom_1) {
    "use strict";
    ...
    var Paginator = /** @class */ (function (_super) {
        ...
        Paginator.prototype.renderFirstLink = function (url) {
            return jsx_runtime_1.jsx(react_router_dom_1.Link, __assign({ to: url }, { children: "First" }), "first");
        };
        Paginator.prototype.renderLastLink = function (url, ind) {
            return jsx_runtime_1.jsx(react_router_dom_1.Link, __assign({ to: url }, { children: "Last" }), "last");
        };
        Paginator.prototype.renderPrevLink = function (url, ind) {
            return jsx_runtime_1.jsx(react_router_dom_1.Link, __assign({ to: url }, { children: "Prev" }), "prev");
        };
        Paginator.prototype.renderPage = function (url, ind) {
            return jsx_runtime_1.jsx(react_router_dom_1.Link, __assign({ to: url }, { children: ind }), ind);
        };
        Paginator.prototype.renderCurrent = function (ind) {
            return jsx_runtime_1.jsx("span", { children: ind }, "current");
        };
        Paginator.prototype.renderNextLink = function (url, ind) {
            return jsx_runtime_1.jsx(react_router_dom_1.Link, __assign({ to: url }, { children: "Next" }), "next");
        };
        ...
        Paginator.prototype.renderPages = function (pages) {
            ...
            return jsx_runtime_1.jsx("div", { children: Object.values(pages) }, void 0);
        };
