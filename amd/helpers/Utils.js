...
define(["require", "exports", "react", "../models/commonModels"], function (require, exports, React, commonModels_1) {
    "use strict";
        ...
        Utils.makeUrl = function (currentPage, newPage, site, contentArgs, gets) {
            ...
            if (typeof section !== 'undefined') {
                if (section.host !== null) { // раздел в поддоменах
                    ...
                    commonModels_1.Console.error('В разделе "' + section.name + '" не указан ни path ни host.');
