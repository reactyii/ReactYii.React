...
var Dropdown = /** @class */ (function (_super) {
    ...
    function Dropdown(props) {
        ...
        _this.subscribeOpenDropdownCallback = function (t) {
            if (t.initiator !== _this)
                _this.close();
        };
        //Console.log('!!!!');
        ...
        _this.subscribeOpenDropdownCallback = _this.subscribeOpenDropdownCallback.bind(_this);
        return _this;
    }
    ...
    Dropdown.prototype.subscribeEvents = function (props) {
        // ��������� �������� ��� �������� ������ ������� ���������
